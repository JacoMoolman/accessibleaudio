...
Assert-Contains $submitIndex "../scripts/voice-catalog.js?v=20260717-production1" "submit page"
Assert-Contains $submitIndex "./styles.css?v=20260717-production1" "submit page"
Assert-Contains $submitIndex "./app.js?v=20260717-production1" "submit page"
