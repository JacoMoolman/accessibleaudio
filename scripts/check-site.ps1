...
Assert-Contains $index "styles.css?v=20260715-motion2" "homepage"
...
Assert-Contains $audiobooks "styles.css?v=20260715-motion2" "audiobook library"
Assert-Contains $audiobooks "scripts/site-motion.js?v=20260715-motion2" "audiobook library"
Assert-Contains $contact "styles.css?v=20260715-motion2" "contact page"
...
Assert-Contains $faq "styles.css?v=20260715-motion2" "FAQ page"
...
Assert-Contains $voiceSamples "styles.css?v=20260715-motion2" "voice samples page"
...
Assert-Contains $submitIndex "./styles.css?v=20260715-motion2" "submit page"
