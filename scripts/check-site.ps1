...
Assert-Contains $voiceCatalogScript "const firstVoiceNumber = 6" "voice catalog script"
...
Assert-Contains $submitIndex "../scripts/voice-catalog.js?v=20260718-cloud1" "submit page"
